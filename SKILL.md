...
- 发布日期：2026-06-28（v2.0.4 修复优化措施表与对话不一致）/ 2026-06-28（v2.0.3 xlsx 改为单 Sheet）/ 2026-06-28（v2.0.2 修复 Windows 编码 + docx 改为纯表格）/ 2026-06-28（v2.0.1 脚本工程化升级）/ 2026-06-27（v2.0.0 首发）
